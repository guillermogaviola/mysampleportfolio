...
<head>
  ...
  <title>Personal Portfolio | Guillermo Gaviola</title>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-links">
                ...
                <a href="{{ url('portfoliodetails')}}" title="More Details"><i class="bx bx-link"></i></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-4">
            <div class="contact-about">
              ...
              <div class="social-links">
                ...
                <a target="_blank" href="https://web.facebook.com/guillermogaviola.s" class="facebook"><i class="bi bi-facebook"></i></a>
                <a target="_blank" href="https://www.instagram.com/guillerms_012/" class="instagram"><i class="bi bi-instagram"></i></a>
